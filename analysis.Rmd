...
The largest economic-affecting weather event type is "```r top_total_dmg$EVTYPE[1]```" with it's property and crop damage costs totaling at \$```r top_total_dmg$[1]```########### <- fix
